...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./MODEKSA.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("NG", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S MODEKSA -X kill
screen -S MODEKSA ./MODEKSA
done
]])  
file:close() 
...
local MODEKSA_Msg = ''  
if msgs > 100 then 
MODEKSA_Msg = 'تفاعلك زفت' 
elseif msgs > 200 then 
MODEKSA_Msg = 'شويه شدها' 
elseif msgs > 300 then 
MODEKSA_Msg = 'شبه متفاعل ' 
elseif msgs > 600 then 
MODEKSA_Msg = 'عود متفاعل' 
elseif msgs > 1000 then 
MODEKSA_Msg = 'متفاعل كفو' 
elseif msgs > 1500 then 
MODEKSA_Msg = 'متفاعل جدا' 
elseif msgs > 2000 then 
MODEKSA_Msg = 'طاك مال تفاعل'  
elseif msgs > 4000 then 
MODEKSA_Msg = 'مخبل بلتفاعل' 
elseif msgs > 4500 then 
MODEKSA_Msg = 'مدمن تفاعل' 
elseif msgs > 5500 then 
MODEKSA_Msg = 'طاك' 
elseif msgs > 7000 then 
MODEKSA_Msg = 'يطك بالكاع' 
elseif msgs > 9500 then 
MODEKSA_Msg = 'دك تفاعل' 
elseif msgs > 10000000000 then 
MODEKSA_Msg = 'ملك التفاعل'
end 
return MODEKSA_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceMODEKSA(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,MODEKSA_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf MODEKSA.lua')
os.execute('wget https://raw.githubusercontent.com/PHFWHDHD/MODEKSA/main/MODEKSA.lua')
...
send(msg.chat_id_, msg.id_,'• عدد القروبات الان > { '..#group..' }'..MODEKSAk..''..MODEKSA..'\n*• الان عدد القروبات الحقيقي > { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
local MODEKSA1_Msg = database:get(bot_id.."MODEKSA1:Add:Filter:Rp2"..text..msg.chat_id_)   
if MODEKSA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'• العضو> ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'NiGGa_SoUrcE')..') \n •'..MODEKSA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if MODEKSA_Msg and not Special(msg) then  
local MODEKSA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if MODEKSA_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"• عضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n•["..MODEKSA_Msg.."] \n") 
else
send(msg.chat_id_,0,"• عضو : {["..data.first_name_.."](T.ME/NiGGa_SoUrcE)}\n•["..MODEKSA_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "•عذرا يا > {["..data.first_name_.."](T.ME/NiGGa_SoUrcE)}\n• الملصق الذي ارسلته تم منعه من القروب \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:set(bot_id.."MODEKSA:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الزخرفه')
database:set(bot_id.."MODEKSA:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."MODEKSA:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."MODEKSA:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الابراج')
database:set(bot_id.."MODEKSA:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.."MODEKSA:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."MODEKSA:age_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل حساب العمر')
database:set(bot_id.."MODEKSA:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.."MODEKSA:age_Bots"..msg.chat_id_) == "open" then
local Textage = text:match("^احسب (.*)$")
ge = https.request('https://mode-dev.tk/Api1/MODEKSAapi.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@NiGGa_SoUrcE','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
...
database:sadd(bot_id.."MODEKSA:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."MODEKSA:blocname"..msg.chat_id_)
...
if name_Black then 
names_Black = database:smembers(bot_id.."MODEKSA:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."MODEKSA:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."MODEKSA:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."MODEKSA:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."MODEKSA:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."MODEKSA:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function keko_tsahke_new(tshake1,tshake2)
if tshake2 and tshake2.first_name_ then 
if tshake2.first_name_:match("(.*)"..database:get(bot_id.."MODEKSA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."MODEKSA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local tshake_nnn = database:get(bot_id.."MODEKSA:nump"..msg.chat_id_) or 5
local tshake_nnn2 = database:get(bot_id.."MODEKSA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(tshake_nnn2) == tonumber(tshake_nnn) or tonumber(tshake_nnn2) > tonumber(tshake_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."MODEKSA:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "•عزيزي >>["..tshake2.username_.."](https://t.me/"..(tshake2.username_ or "NiGGa_SoUrcE")..")\n•عليك وضع التوحيد ⪼ {`"..database:get(bot_id.."MODEKSA:teh"..msg.chat_id_).."`} بجانب اسمك\n•عدد المحاولات المتبقيه {"..(tonumber(tshake_nnn) - tonumber(tshake_nnn2)).."}")
end
end
end
end
...
local MODEKSAChengName = database:get(bot_id.."MODEKSA:Cheng:Name"..data.id_)
if not data.first_name_ then 
if MODEKSAChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..MODEKSAChengName..']')
database:del(bot_id.."MODEKSA:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if MODEKSAChengName ~= data.first_name_ then 
local Text = {
  "جان اسمك خوش اسم ",
"ليش غيرت اسمك يحلو ",
"هذا لحلو غير اسمه ",
...
database:set(bot_id.."MODEKSA:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local MODEKSAChengUserName = database:get(bot_id.."MODEKSA:Cheng:UserName"..data.id_)
if not data.username_ then 
if MODEKSAChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..MODEKSAChengUserName..']')
database:del(bot_id.."MODEKSA:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if MODEKSAChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."MODEKSA:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local MODEKSAChengPhoto = database:get(bot_id.."MODEKSA:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if MODEKSAChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صوره الحلو 😂👌🏻")
database:del(bot_id.."MODEKSA:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if MODEKSAChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."MODEKSA:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'NIGGA_SoUrcE')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'NIGGA_SoUrcE')..') \n*•تم قفـل الدردشه*\n')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' بواسطه > ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'NIGGA_SoUrcE')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'NIGGA_SoUrcE')..') \n*تم قفـل الالعاب*\n')  
end,nil)   
...
database:set(bot_id.."MODEKSA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."MODEKSA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."MODEKSA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."MODEKSA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."MODEKSA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."MODEKSA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"•تم منع الكلمه مع التحذير")  
database:del(bot_id.."MODEKSA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."MODEKSA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."MODEKSA1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."MODEKSA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"•ارسل الكلمه الان")  
database:set(bot_id.."MODEKSA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."MODEKSA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."MODEKSA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MODEKSA1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."MODEKSA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."MODEKSA1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."MODEKSA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MODEKSA1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."MODEKSA1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n•قائمة المنع \n *•●○●○●○●•ٴ*\n"
for k,v in pairs(list) do  
local MODEKSA_Msg = database:get(bot_id.."MODEKSA1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." > {"..MODEKSA_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n• العضو > ['..result.title_..'](t.me/'..(text1[3] or 'NiGGa_SoUrcE')..')'..'\n تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if not database:get(bot_id..'MODEKSA:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'MODEKSA:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
send(msg.chat_id_, msg.id_,'['..MODEKSA_Msg[math.random(#MODEKSA_Msg)]..']') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n• العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'MODEKSA')..') '
...
Text = ' • عدد جهاتك > ['..Num..'](https://t.me/NiGGa_SoUrcE) •'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
-- vardump(data) 
MODEKSAdx(msg.chat_id_, msg.id_, '• ايدي المجموعة > ( '..msg.chat_id_..' )\n عدد الادمنيه > ( *'..data.administrator_count_..' )*\n• عدد المحظورين > ( *'..data.kicked_count_..' )*\n• عدد الاعضاء > ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if not database:get(bot_id..'MODEKSA:Reply:Mute'..msg.chat_id_) then
...
database:del(bot_id..'MODEKSA:Reply:Mute'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'•تم تفعيل ردود البوت')
return false
end
if text == 'تعطيل ردود البوت' and Mod(msg) and database:get(bot_id.."AL:Sre:stats") then
database:set(bot_id..'MODEKSA:Reply:Mute'..msg.chat_id_,true)
...
--------------------------------------------------------------------------------------------------------------
SourceMODEKSA(data.message_,data)
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local MODEKSAAbot = database:get(bot_id.."MODEKSA1:Add:Filter:Rp2"..text..result.chat_id_)   
if MODEKSAAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"•العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n•["..MODEKSAAbot.."] \n") 
else
send(msg.chat_id_,0,"•العضو : {["..data.first_name_.."](T.ME/NiGGa_SoUrcE)}\n•["..MODEKSAAbot.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
...
------------------------------------------------------------------------
if text then
local MODEKSA1_Msg = database:get(bot_id.."MODEKSA1:Add:Filter:Rp2"..text..result.chat_id_)   
if MODEKSA1_Msg then    
send(msg.chat_id_, msg.id_,"•"..MODEKSA1_Msg)
